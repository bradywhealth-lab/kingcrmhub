 ...
 *
 * Server-rendered via the auth segment loading.tsx and the client page's
 * Suspense fallback, this ships inside the initial HTML payload, so it paints
        ...
        <section className="relative hidden flex-1 overflow-hidden bg-[#0c111b] px-10 py-12 text-white lg:flex lg:flex-col lg:justify-between xl:px-14">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#18b897]">
                <Sparkles className="h-5 w-5 text-[#0c111b]" />
              </div>
              <div>
        ...
        <section className="flex w-full flex-col justify-between px-5 py-6 sm:px-8 lg:w-[520px] lg:px-10 lg:py-10 xl:w-[560px]">
          <div>
            <div className="mb-10 flex items-center gap-3 lg:hidden">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#18b897]">
                <Sparkles className="h-5 w-5 text-[#0c111b]" />
              </div>
              <div>
            ...
            <div className="mb-8 space-y-2">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#127c66]">Secure workspace access</p>
              <div className="h-9 w-64 animate-pulse rounded-xl bg-[#0c111b]/10" />
              <div className="h-5 w-full animate-pulse rounded-lg bg-[#0c111b]/8" />
              <div className="h-5 w-3/4 animate-pulse rounded-lg bg-[#0c111b]/8" />
            </div>

            <div className="mb-6 grid grid-cols-2 gap-1 rounded-2xl border border-[rgba(31,42,54,0.08)] bg-[#f4f0e6] p-1">
              <div className="h-12 animate-pulse rounded-[14px] bg-white shadow-[0_10px_25px_rgba(31,42,54,0.08)]" />
              <div className="h-12 animate-pulse rounded-[14px] bg-[#0c111b]/5" />
            </div>

            <div className="space-y-4">
              <div className="space-y-2">
                <div className="h-3 w-24 animate-pulse rounded bg-[#0c111b]/15" />
                <div className="h-12 animate-pulse rounded-2xl bg-white shadow-sm" />
              </div>
              <div className="space-y-2">
                <div className="h-3 w-16 animate-pulse rounded bg-[#0c111b]/15" />
                <div className="h-12 animate-pulse rounded-2xl bg-white shadow-sm" />
              </div>
              <div className="h-12 w-full animate-pulse rounded-2xl bg-[#18b897]" />
              <div className="h-14 w-full animate-pulse rounded-2xl bg-white/60" />
            </div>
          </div>

          <p className="mt-10 text-center text-xs text-[#0c111b]/35">© 2026 King CRM Hub. Proof. Decision. Next Move.</p>
        </section>
      </div>
    </main>
  )
